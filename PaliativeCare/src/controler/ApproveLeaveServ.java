...
/**
 * Servlet implementation class ApproveLeaveServ
 */
@WebServlet("/ApproveLeaveServ")
public class ApproveLeaveServ extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/erpdb","root","");
			...
			response.sendRedirect("Health/HRLeaveDetail.jsp");
		}
		catch(Exception e )
		{
			e.printStackTrace();
