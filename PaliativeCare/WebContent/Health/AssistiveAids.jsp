...
<div class="container col-sm-12 wow zoomIn">
  <h2 align="center">REGULAR TECHNOLOGY AIDS AND MONITORING/ ASSISTIVE DEVICES</h2>                                                                                      
  <div class="table-responsive">
<table class="table table-striped table-bordered" id="tbldata" cellspacing="0" width="100%">
    <thead>
  <tr>
  <th>List any Devices/aids</th>
  <th>Purpose/Function</th>
  <th>Responsibility(Who makes sure things work properly)</th>
  </tr>
  </thead>
    <tbody>
  <tr>
