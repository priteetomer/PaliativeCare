...
List<Volunteer> listOfVol= b.getAllVolunteers();
...
<table class="table table-striped table-bordered" id="tbldata" cellspacing="0" width="100%">
  ...
  <tr>
  	<td><c:out value="${vol.pID}"></c:out></td>
  	<td><c:out value="${vol.fname}"></c:out></td>
  	<td><c:out value="${vol.lname}"></c:out></td>
  	<td><c:out value="${vol.email}"></c:out></td>
  	<td><c:out value="${vol.dob}"></c:out></td>
  	<td><c:out value="${vol.gender}"></c:out></td>
  	<td><c:out value="${vol.contactno}"></c:out></td>
  	<td><c:out value="${vol.address}"></c:out></td>
  <td><a href="../DeleteUserServlet?id=${vol.pID}">Delete</a></td>
