...
<div class="container col-sm-12 wow zoomIn">
  <h2 align="center">PRACTICAL HELP(Informal or Unpaid)</h2>                                                                                      
  <div class="table-responsive">
  <form action="../Informalcare" method="post" name="formalcare" id="formalcare" >
