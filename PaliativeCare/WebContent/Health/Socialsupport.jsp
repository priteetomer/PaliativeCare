...
<div class="container col-sm-12 wow zoomIn">
  <h2 align="center">SOCIAL SUPPORT</h2>                                                                                      
...
<table class="table table-striped table-bordered" id="tbldata" cellspacing="0" width="100%">
 ...
 <div class="form-group">
								...
								<option value="-1">Select Activity</option>
									<option>Fitness or exercise</option>
									<option>Drop in or friendly visit</option>
									<option>Recreation/Indoor Activities</option>
									<option>Entertainment-Music</option>
									<option>Entertainment-reading</option>
									<option>Entertainment-shows</option>
									<option>Entertainments-others</option>
								</select>
							</div>
  	<td>
  	<div class="form-group"  >
