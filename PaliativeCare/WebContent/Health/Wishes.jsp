...
<div class="container col-sm-12 wow zoomIn">
  <h2 align="center">THINGS I HAVE IN PLACE</h2>                                                                                      
...
<table class="table table-striped table-bordered" id="tbldata" cellspacing="0" width="100%">
  ...
  <th>YES</th>
  <th>NO</th>
  <th>WHERE KEPT OR WHO</th>
  </tr>
  </thead>
    <tbody>
  <tr>
  	<th>ADVANCED STATEMENT OF PREFERENCES AND WISHES</th>
  	<td>
  	<div class="form-group"  >
  	<input  type="radio" name="namerel"   id="namerel" >
	</div>
	</td>
  	<td>
  	<div class="form-group"  >
